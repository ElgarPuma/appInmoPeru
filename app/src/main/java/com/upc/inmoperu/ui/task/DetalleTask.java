...
public class DetalleTask extends AsyncTask<String,Void,String> {
    ...
    public DetalleTask(Context ctx, String linkAPI){
    ...
    protected String  doInBackground(String... params) {
        ...
        try {
            ...
            parameterPost.put("cpagoid",Integer.parseInt(params[0]));
            parameterPost.put("productoid",Integer.parseInt(params[1]));
